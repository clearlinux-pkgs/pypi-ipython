...
Source0  : https://files.pythonhosted.org/packages/43/ac/82acd7bf004bc916f45cdb01622f3ef88199465ca6a7ba0bcf22db27226f/ipython-8.22.2.tar.gz
...
%prep
%setup -q -n ipython-8.22.2
cd %{_builddir}/ipython-8.22.2
pushd ..
cp -a ipython-8.22.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709568675
