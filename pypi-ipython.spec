...
Source0  : https://files.pythonhosted.org/packages/7f/59/05e94e067afb61460f0d5229a1edb800e2f65b8436085fad9cd262d80d45/ipython-8.6.0.tar.gz
...
%prep
%setup -q -n ipython-8.6.0
cd %{_builddir}/ipython-8.6.0
pushd ..
cp -a ipython-8.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667227245
