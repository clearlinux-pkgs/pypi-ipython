...
Source0  : https://files.pythonhosted.org/packages/d7/2e/d578cafc51642bb0e4c626e29ca1d580c6a884f540049f744df405373f3a/ipython-8.23.0.tar.gz
...
%prep
%setup -q -n ipython-8.23.0
cd %{_builddir}/ipython-8.23.0
pushd ..
cp -a ipython-8.23.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712001147
