...
Source0  : https://files.pythonhosted.org/packages/82/2b/026af47da09998404f51064d328f5f1f68c78829082d2945be489343fde6/ipython-8.7.0.tar.gz
...
%prep
%setup -q -n ipython-8.7.0
cd %{_builddir}/ipython-8.7.0
pushd ..
cp -a ipython-8.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672282606
