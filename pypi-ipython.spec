...
Source0  : https://files.pythonhosted.org/packages/9d/02/63a84444a7409b3c0acd1de9ffe524660e0e5d82ee473e78b45e5bfb64a4/ipython-9.2.0.tar.gz
...
%prep
%setup -q -n ipython-9.2.0
cd %{_builddir}/ipython-9.2.0
pushd ..
cp -a ipython-9.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745613249
