...
Source0  : https://files.pythonhosted.org/packages/70/9a/6b8984bedc990f3a4aa40ba8436dea27e23d26a64527de7c2e5e12e76841/ipython-9.1.0.tar.gz
...
%prep
%setup -q -n ipython-9.1.0
cd %{_builddir}/ipython-9.1.0
pushd ..
cp -a ipython-9.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744038066
