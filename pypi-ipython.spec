...
Source0  : https://files.pythonhosted.org/packages/83/aa/6b5bd15d4914394a4f6bd5a4d88dee2d5ddd1b346b8b60fd9e735223a8ea/ipython-8.21.0.tar.gz
...
%prep
%setup -q -n ipython-8.21.0
cd %{_builddir}/ipython-8.21.0
pushd ..
cp -a ipython-8.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706719260
