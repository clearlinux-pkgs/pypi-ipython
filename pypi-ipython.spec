...
Source0  : https://files.pythonhosted.org/packages/54/80/406f9e3bde1c1fd9bf5a0be9d090f8ae623e401b7670d8f6fdf2ab679891/ipython-9.4.0.tar.gz
...
Requires: pypi(ipython_pygments_lexers)
Requires: pypi(jedi)
...
%prep
%setup -q -n ipython-9.4.0
cd %{_builddir}/ipython-9.4.0
pushd ..
cp -a ipython-9.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751378193
