...
Source0  : https://files.pythonhosted.org/packages/05/a1/7dd9b71ede281a4433b10005ad07aeeb8d114cf6f6424ee48c2bcf082799/ipython-8.10.0.tar.gz
...
%prep
%setup -q -n ipython-8.10.0
cd %{_builddir}/ipython-8.10.0
pushd ..
cp -a ipython-8.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676044586
