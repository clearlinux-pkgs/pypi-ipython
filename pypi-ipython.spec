...
Source0  : https://files.pythonhosted.org/packages/c5/d1/187474d64bdefcb6804c1a3a1597d9e94f287e71c06f50f7784d56833fb7/ipython-8.20.0.tar.gz
...
%prep
%setup -q -n ipython-8.20.0
cd %{_builddir}/ipython-8.20.0
pushd ..
cp -a ipython-8.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704728521
