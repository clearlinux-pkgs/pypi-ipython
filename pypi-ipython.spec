...
Source0  : https://files.pythonhosted.org/packages/2a/48/7a2caa38a3103d18725fc809a379a4c8047b304d0731fde5f7c4bbf6bbe9/ipython-8.9.0.tar.gz
...
%prep
%setup -q -n ipython-8.9.0
cd %{_builddir}/ipython-8.9.0
pushd ..
cp -a ipython-8.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674834644
