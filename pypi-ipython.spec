...
Source0  : https://files.pythonhosted.org/packages/7e/f4/dc45805e5c3e327a626139c023b296bafa4537e602a61055d377704ca54c/ipython-8.26.0.tar.gz
...
%prep
%setup -q -n ipython-8.26.0
cd %{_builddir}/ipython-8.26.0
pushd ..
cp -a ipython-8.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719592252
