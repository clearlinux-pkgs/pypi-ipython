...
Source0  : https://files.pythonhosted.org/packages/f0/49/02663ec5fcfe3a8c9c17b2b6195db30c182749d14ae1bb7f91944b8f4f69/ipython-8.24.0.tar.gz
...
%prep
%setup -q -n ipython-8.24.0
cd %{_builddir}/ipython-8.24.0
pushd ..
cp -a ipython-8.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714141281
