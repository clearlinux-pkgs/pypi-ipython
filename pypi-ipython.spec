...
Source0  : https://files.pythonhosted.org/packages/a7/e1/7c277c1dd0b0520bf07070c3921ff1986a2eb3db704ad91f0ac46fb42d8f/ipython-8.11.0.tar.gz
...
%prep
%setup -q -n ipython-8.11.0
cd %{_builddir}/ipython-8.11.0
pushd ..
cp -a ipython-8.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677600664
