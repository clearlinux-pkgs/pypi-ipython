...
Source0  : https://files.pythonhosted.org/packages/1c/5a/facbb5a0650e68b16134ce787b0990ee47f8b67316b0d844d9b183f212e6/ipython-8.25.0.tar.gz
...
%prep
%setup -q -n ipython-8.25.0
cd %{_builddir}/ipython-8.25.0
pushd ..
cp -a ipython-8.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717432328
