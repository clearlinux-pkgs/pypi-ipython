...
Source0  : https://files.pythonhosted.org/packages/57/24/d4fabaca03c8804bf0b8d994c8ae3a20e57e9330d277fb43d83e558dec5e/ipython-8.27.0.tar.gz
...
%prep
%setup -q -n ipython-8.27.0
cd %{_builddir}/ipython-8.27.0
pushd ..
cp -a ipython-8.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725306007
