...
Source0  : https://files.pythonhosted.org/packages/dc/09/4c7e06b96fbd203e06567b60fb41b06db606b6a82db6db7b2c85bb72a15c/ipython-9.3.0.tar.gz
...
%prep
%setup -q -n ipython-9.3.0
cd %{_builddir}/ipython-9.3.0
pushd ..
cp -a ipython-9.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748884634
