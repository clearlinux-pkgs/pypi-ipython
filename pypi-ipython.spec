...
Source0  : https://files.pythonhosted.org/packages/25/a5/dda90aa8cb931458a357ae65ff4341d7694464f322b095a438489440dc7c/ipython-8.5.0.tar.gz
...
%prep
%setup -q -n ipython-8.5.0
cd %{_builddir}/ipython-8.5.0
pushd ..
cp -a ipython-8.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662480688
